...
class PipelineController extends AppController
{
    ...
    public function run(): void
    {
        ...
        $claim = (new \App\Service\ClaimCalculator())->calculate([
            ...
            'air_downgrade_booked_class' => $meta['air_downgrade_booked_class'] ?? null,
            'air_downgrade_flown_class' => $meta['air_downgrade_flown_class'] ?? null,
            'air_downgrade_refund_percent' => $meta['air_downgrade_refund_percent'] ?? null,
            'air_distance_band' => $meta['air_distance_band'] ?? null,

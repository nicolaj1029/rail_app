...
$this->assign('title', 'Fly');
$fullBleedLanding = !empty($fullBleedLanding);
$brandHref = (string)($brandHref ?? '/fly-ny');
...
if ($lang === 'en') {
    $pageTranslations += [
        ...
        'Fly entry · spring trin 1 over' => 'Air entry · skip step 1',
        'Afklar hurtigt,' => 'Quickly clarify,',
        'om dit fly giver ret til kompensation.' => 'whether your flight entitles you to compensation.',
        'Vi går direkte til billet, flyafgang og hændelse. Derefter vurderer vi kompensation, assistance og refusion eller ombooking efter flyreglerne.' => 'We go directly to ticket, flight and incident. Then we assess compensation, assistance and refund or rerouting under air passenger rules.',
        ...
        'Trin 2: Booking' => 'Step 2: Booking',
        'Trin 3: Vælg fly' => 'Step 3: Choose flight',
        'Trin 4: Hændelse' => 'Step 4: Incident',
        'Trin 5: Refund / ombooking' => 'Step 5: Refund / rerouting',
        'Trin 6: Assistance' => 'Step 6: Assistance',
        'Trin 7: Nedgradering' => 'Step 7: Downgrade',
        'Trin 8: Kontakttrin' => 'Step 8: Contact step',
        'Vælg rejsetype og gå direkte videre' => 'Choose journey type and continue directly',
        'Du står midt i en forsinkelse, aflysning eller boarding-situation nu. Gå direkte til hændelsen og få vurderet kompensation, assistance og ombooking.' => 'You are in the middle of a delay, cancellation or boarding situation right now. Go straight to the incident and get compensation, assistance and rerouting assessed.',
        ...
        'Afgangen ligger foran dig. Brug dette spor ved varslet aflysning, boarding-problemer eller forventet forsinkelse før afgang.' => 'Departure is still ahead of you. Use this track for notified cancellation, boarding problems or expected delay before departure.',
        'Hvad kan du få?' => 'What can you get?',
        'Prøv et hurtigt fly-estimat' => 'Try a quick flight estimate',
        'Juster forsinkelse og flydistance og se, hvornår kompensation typisk bliver relevant efter EU 261/2004.' => 'Adjust delay and flight distance and see when compensation typically becomes relevant under EU 261/2004.',
        'Estimeret kompensation' => 'Estimated compensation',
        'Ingen kompensation' => 'No compensation',
        '250 EUR ved 180+ minutters forsinkelse og kort flydistance' => 'EUR 250 at 180+ minutes of delay and short flight distance',
        'EUR ved 180+ min' => 'EUR at 180+ min',
        'Din forsinkelse' => 'Your delay',
        'Flydistance' => 'Flight distance',
        'Ingen kompensation under 180 minutters forsinkelse' => 'No compensation below 180 minutes of delay',
    ];
} elseif ($lang === 'fr') {
    $this->assign('title', 'Air');
    $pageTranslations += [
        ...
        'Fly entry · spring trin 1 over' => 'Entree air · sautez l etape 1',
        'Afklar hurtigt,' => 'Clarifiez rapidement,',
        'om dit fly giver ret til kompensation.' => 'si votre vol donne droit a une compensation.',
        'Vi går direkte til billet, flyafgang og hændelse. Derefter vurderer vi kompensation, assistance og refusion eller ombooking efter flyreglerne.' => 'Nous allons directement au billet, au vol et a l incident. Ensuite nous evaluons compensation, assistance et remboursement ou reacheminement selon les regles aeriennes.',
        ...
        'Trin 2: Booking' => 'Etape 2 : Reservation',
        'Trin 3: Vælg fly' => 'Etape 3 : Choisir le vol',
        'Trin 4: Hændelse' => 'Etape 4 : Incident',
        'Trin 5: Refund / ombooking' => 'Etape 5 : Remboursement / reacheminement',
        'Trin 6: Assistance' => 'Etape 6 : Assistance',
        'Trin 7: Nedgradering' => 'Etape 7 : Declassement',
        'Trin 8: Kontakttrin' => 'Etape 8 : Contact',
        'Vælg rejsetype og gå direkte videre' => 'Choisissez le type de trajet et continuez directement',
        'Du står midt i en forsinkelse, aflysning eller boarding-situation nu. Gå direkte til hændelsen og få vurderet kompensation, assistance og ombooking.' => 'Vous etes au milieu d un retard, d une annulation ou d une situation d embarquement. Allez directement a l incident et faites evaluer compensation, assistance et reacheminement.',
        ...
        'Afgangen ligger foran dig. Brug dette spor ved varslet aflysning, boarding-problemer eller forventet forsinkelse før afgang.' => 'Le depart est encore devant vous. Utilisez cette piste en cas d annulation annoncee, de problemes d embarquement ou de retard attendu avant le depart.',
        'Hvad kan du få?' => 'Que pouvez-vous obtenir ?',
        'Prøv et hurtigt fly-estimat' => 'Essayez une estimation rapide pour le vol',
        'Juster forsinkelse og flydistance og se, hvornår kompensation typisk bliver relevant efter EU 261/2004.' => 'Ajustez le retard et la distance du vol et voyez quand la compensation devient en general pertinente selon le reglement UE 261/2004.',
        'Estimeret kompensation' => 'Compensation estimee',
        'Ingen kompensation' => 'Aucune compensation',
        '250 EUR ved 180+ minutters forsinkelse og kort flydistance' => '250 EUR pour 180+ minutes de retard et une courte distance de vol',
        'EUR ved 180+ min' => 'EUR a 180+ min',
        'Din forsinkelse' => 'Votre retard',
        'Flydistance' => 'Distance du vol',
        'Ingen kompensation under 180 minutters forsinkelse' => 'Aucune compensation en dessous de 180 minutes de retard',
        ...
        'Vi vurderer hurtigt, om du kan få kompensation og dækning for nødvendige udgifter under flyrejsen.' => 'Nous evaluons rapidement si vous pouvez obtenir une compensation et la prise en charge des depenses necessaires pendant le voyage aerien.',
        'Mad, hotel og nødvendig hjælp ved forsinkelse eller aflysning' => 'Repas, hotel et aide necessaire en cas de retard ou d annulation',
        'Ny flyvning, pengene tilbage og nødvendige ombookingsudgifter' => 'Nouveau vol, remboursement et frais de rebooking necessaires',
        'Vores rolle' => 'Notre role',
        'Vi afklarer først dit flyspor og kan derefter føre kravet videre for dig' => 'Nous clarifions d abord votre parcours vol et pouvons ensuite poursuivre la reclamation pour vous',
        ...
        'Hvad vurderer I i flysporet?' => 'Que verifiez-vous dans le parcours vol ?',
        'Vi vurderer tre spor: kompensation efter EU 261/2004, assistance ved forsinkelse eller aflysning og refusion eller ombooking af selve flyrejsen.' => 'Nous evaluons trois pistes : la compensation selon le reglement UE 261/2004, l assistance en cas de retard ou d annulation, et le remboursement ou le reacheminement du voyage aerien lui-meme.',
        ...
        'Ja, når flyreglerne åbner for assistance eller ombooking, vurderer vi også nødvendige udgifter som mad, hotel og videre transport.' => 'Oui, lorsque les regles aeriennes ouvrent le droit a l assistance ou au reacheminement, nous evaluons aussi les depenses necessaires comme les repas, l hotel et la continuation du trajet.',
        'Om os' => 'A propos',
        'Vi vurderer flypassagerers rettigheder' => 'Nous evaluons les droits des passagers aeriens',
        ...
        'Landing-siden flytter rejsestatus op foran flowet. Derfor går du direkte videre til billet, flyafgang og hændelse, som afgør retningen i sagen.' => 'La page d entree place le statut du trajet avant le flow. Vous passez donc directement au billet, au depart du vol et a l incident, qui determinent la direction du dossier.',
        ...
        'Vi svarer så hurtigt som muligt og hjælper dig videre til det rigtige flyspor.' => 'Nous repondons aussi vite que possible et vous aidons a poursuivre dans le bon parcours vol.',
        'flykrav vurderet' => 'reclamations vol evaluees',
        'kompensation, assistance og remedies' => 'compensation, assistance et remedies',
        'til hurtig vurdering' => 'pour une evaluation rapide',
        'Baseret paa EU-forordning 261/2004' => 'Base sur le reglement UE 261/2004',
    ];
}
...
$travelCards = [
    [
        ...
        'summary' => 'Du står midt i en forsinkelse, aflysning eller boarding-situation nu. Gå direkte til hændelsen og få vurderet kompensation, assistance og ombooking.',
        'badge' => 'Live',
        'badgeClass' => 'is-live',
    ...
    [
        ...
        'summary' => 'Afgangen ligger foran dig. Brug dette spor ved varslet aflysning, boarding-problemer eller forventet forsinkelse før afgang.',
        'badge' => 'Før afgang',
...
$tc6PreviewLinks = [
    'entitlements' => $this->Url->build('/tc6/air/entitlements') . '?cb=' . rawurlencode($previewCb) . $langPreviewSuffix,
    'reservation' => $this->Url->build('/tc6/air/reservation') . '?cb=' . rawurlencode($previewCb) . $langPreviewSuffix,
    'flight' => $this->Url->build('/tc6/air/flight') . '?cb=' . rawurlencode($previewCb) . $langPreviewSuffix,
    'incident' => $this->Url->build('/tc6/air/incident') . '?cb=' . rawurlencode($previewCb) . $langPreviewSuffix,
    'remedies' => $this->Url->build('/tc6/air/remedies') . '?cb=' . rawurlencode($previewCb) . $langPreviewSuffix,
    'assistance' => $this->Url->build('/tc6/air/assistance') . '?cb=' . rawurlencode($previewCb) . $langPreviewSuffix,
    'downgrade' => $this->Url->build('/tc6/air/downgrade') . '?cb=' . rawurlencode($previewCb) . $langPreviewSuffix,
    'contact' => $this->Url->build('/tc6/air/contact') . '?cb=' . rawurlencode($previewCb) . $langPreviewSuffix,
];
?>
...
<style>
  .tc-air {
    --tc-accent: #0ea5e9;
    --tc-accent-soft: rgba(14, 165, 233, 0.18);
    --tc-accent-border: rgba(125, 211, 252, 0.46);
    --tc-accent-text: #7dd3fc;
  }
  ...
  .tc-hero {
    ...
    overflow: hidden;
    background:
      radial-gradient(circle at 78% 18%, rgba(125, 211, 252, 0.22), transparent 28%),
      linear-gradient(180deg, #10233d 0%, #0f1b2d 58%, #0b1626 100%);
    border-radius: 24px;
...
<div class="tc-page tc-air<?= $fullBleedLanding ? ' tc-page--fullbleed' : '' ?>">
  <section class="tc-hero">
    <div class="tc-hero-grid">
      <!-- Tekst venstre -->
      <div>
        <div class="tc-pill">Fly entry · spring trin 1 over</div>
        <h1>Afklar hurtigt,<span>om dit fly giver ret til kompensation.</span></h1>
        <p class="tc-hero-copy">Vi går direkte til billet, flyafgang og hændelse. Derefter vurderer vi kompensation, assistance og refusion eller ombooking efter flyreglerne.</p>
        ...
        <div class="tc-preview-links">
          ...
          <a class="tc-preview-link" href="<?= h($tc6PreviewLinks['reservation']) ?>">Trin 2: Booking</a>
          <a class="tc-preview-link" href="<?= h($tc6PreviewLinks['flight']) ?>">Trin 3: Vælg fly</a>
          <a class="tc-preview-link" href="<?= h($tc6PreviewLinks['incident']) ?>">Trin 4: Hændelse</a>
          <a class="tc-preview-link" href="<?= h($tc6PreviewLinks['remedies']) ?>">Trin 5: Refund / ombooking</a>
          <a class="tc-preview-link" href="<?= h($tc6PreviewLinks['assistance']) ?>">Trin 6: Assistance</a>
          <a class="tc-preview-link" href="<?= h($tc6PreviewLinks['downgrade']) ?>">Trin 7: Nedgradering</a>
          <a class="tc-preview-link" href="<?= h($tc6PreviewLinks['contact']) ?>">Trin 8: Kontakttrin</a>
        </div>
        <?php endif; ?>
      </div>
      ...
      <div class="tc-hero-3d" aria-hidden="true">
        <svg class="tc-hero-svg" viewBox="0 0 520 360" role="presentation" focusable="false">
          <defs>
            <linearGradient id="airSky" x1="0" x2="0" y1="0" y2="1">
              <stop offset="0%" stop-color="#1a3d69" />
              <stop offset="62%" stop-color="#10233d" />
              <stop offset="100%" stop-color="#0b1626" />
            </linearGradient>
            <linearGradient id="airRunway" x1="0" x2="1" y1="0" y2="0">
              <stop offset="0%" stop-color="#0f172a" />
              <stop offset="100%" stop-color="#1e293b" />
            </linearGradient>
          </defs>
          <rect x="0" y="0" width="520" height="360" rx="20" fill="url(#airSky)" />
          <ellipse cx="110" cy="92" rx="56" ry="16" fill="#ffffff" opacity=".08" />
          <ellipse cx="208" cy="74" rx="82" ry="22" fill="#ffffff" opacity=".06" />
          <rect x="0" y="270" width="520" height="90" fill="#0b1220" />
          <rect x="30" y="282" width="460" height="16" rx="8" fill="url(#airRunway)" />
          <rect x="226" y="286" width="68" height="6" rx="3" fill="#f8fafc" opacity=".72" />
          <g class="tc-anim-light" opacity=".72">
            <circle cx="430" cy="112" r="22" fill="#fef3c7" />
            <circle cx="430" cy="112" r="34" fill="#fef3c7" opacity=".18" />
          </g>
          <rect x="425" y="118" width="10" height="142" rx="5" fill="#475569" />
          <g class="tc-anim-smoke-1" opacity=".55">
            <path d="M270 120c36-34 68-48 116-56" stroke="#cbd5e1" stroke-width="5" stroke-linecap="round" fill="none" />
          </g>
          <g class="tc-anim-smoke-2" opacity=".45">
            <path d="M260 132c44-12 88-18 140-18" stroke="#e2e8f0" stroke-width="4" stroke-linecap="round" fill="none" />
          </g>
          <g class="tc-anim-train">
            <path d="M118 180c58-2 112-20 168-46l28-14 72-22 7 20-57 23-21 14 62 6 40 18-10 18-58-4-72-9-29 7-48 33-24 3-12-6 28-26-55 0-28 8-8-18 17-7z" fill="#e2e8f0" />
            <path d="M315 126l18-20 49-18 6 14-38 20z" fill="#f8fafc" />
            <circle class="tc-anim-headlight" cx="166" cy="176" r="9" fill="#fef3c7" opacity=".94" />
          </g>
        </svg>
      </div>
    </div>
        ...
        <span class="tc-card-icon" aria-hidden="true">
          <?php if ($card['icon'] === 'live'): ?>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round">
              <path d="M2 16l20-8-20-2 6 6-6 4z"></path>
              <path d="M10 14l1.5 5"></path>
              <path d="M14 12l5 5"></path>
            </svg>
  ...
  <section class="tc-comp" id="air-comp-teaser">
    <div class="tc-comp-head">
      <div>
        <div class="tc-comp-kicker">Hvad kan du få?</div>
        <h2 class="tc-comp-title">Prøv et hurtigt fly-estimat</h2>
        <p class="tc-comp-copy">Juster forsinkelse og flydistance og se, hvornår kompensation typisk bliver relevant efter EU 261/2004.</p>
      </div>
      <div class="tc-comp-amount">
        <div class="tc-comp-amount-label">Estimeret kompensation</div>
        <div class="tc-comp-amount-value" id="tcCompAmount">250 EUR</div>
        <div class="tc-comp-amount-sub" id="tcCompAmountSub">250 EUR ved 180+ minutters forsinkelse og kort flydistance</div>
      </div>
    </div>

    <div class="tc-comp-tier-grid">
      <div class="tc-comp-tier tc-comp-tier-card is-gray" data-tier="0">
        <div class="tc-comp-tier-range">0–179 min</div>
        <div class="tc-comp-tier-value">0%</div>
        <div class="tc-comp-tier-label">Ingen kompensation</div>
      </div>
      <div class="tc-comp-tier tc-comp-tier-card is-amber is-active" data-tier="250">
        <div class="tc-comp-tier-range">≤ 1500 km</div>
        <div class="tc-comp-tier-value">250</div>
        <div class="tc-comp-tier-label">EUR ved 180+ min</div>
      </div>
      <div class="tc-comp-tier tc-comp-tier-card is-green" data-tier="400">
        <div class="tc-comp-tier-range">1500–3500 km / 3500+ km</div>
        <div class="tc-comp-tier-value">400+</div>
        <div class="tc-comp-tier-label">EUR ved 180+ min</div>
      </div>
    </div>
    ...
    <div class="tc-comp-slider-grid">
      <div class="tc-comp-slider">
        <div class="tc-comp-slider-label">
          ...
          <span class="tc-comp-slider-value" id="tcDelayValue">180 min</span>
        </div>
        <input id="tcDelayRange" type="range" min="0" max="360" value="180" />
      </div>
      <div class="tc-comp-slider">
        <div class="tc-comp-slider-label">
          <span>Flydistance</span>
          <span class="tc-comp-slider-value" id="tcPriceValue">1200 km</span>
        </div>
        <input id="tcPriceRange" type="range" min="250" max="6000" step="50" value="1200" />
      </div>
    </div>
  </section>
  ...
  <section class="tc-grid">
    <div class="tc-panel">
      ...
      <div class="tc-rights-card">
        <p class="tc-rights-helper">Vi vurderer hurtigt, om du kan få kompensation og dækning for nødvendige udgifter under flyrejsen.</p>
        <div class="tc-rights-grid">
          <div class="tc-rights-cell">
            <div class="tc-rights-cell-label">Kompensation</div>
            <div class="tc-rights-cell-value">250, 400 eller 600 EUR ved lange forsinkelser og aflysninger</div>
          </div>
          <div class="tc-rights-cell">
            <div class="tc-rights-cell-label">Assistance</div>
            <div class="tc-rights-cell-value">Mad, hotel og nødvendig hjælp ved forsinkelse eller aflysning</div>
          </div>
          <div class="tc-rights-cell">
            <div class="tc-rights-cell-label">Refusion / ombooking</div>
            <div class="tc-rights-cell-value">Ny flyvning, pengene tilbage og nødvendige ombookingsudgifter</div>
          </div>
          <div class="tc-rights-cell">
            <div class="tc-rights-cell-label">Vores rolle</div>
            <div class="tc-rights-cell-value">Vi afklarer først dit flyspor og kan derefter føre kravet videre for dig</div>
          </div>
        </div>
  ...
  <section class="tc-info-grid">
    <section class="tc-panel" id="faq">
      ...
      <div class="tc-accordion">
        ...
        <details>
          <summary>Hvad vurderer I i flysporet?</summary>
          <div class="tc-accordion-body">
            <p>Vi vurderer tre spor: kompensation efter EU 261/2004, assistance ved forsinkelse eller aflysning og refusion eller ombooking af selve flyrejsen.</p>
          </div>
        </details>
        <details>
        ...
        <details>
          ...
          <div class="tc-accordion-body">
            <p>Ja, når flyreglerne åbner for assistance eller ombooking, vurderer vi også nødvendige udgifter som mad, hotel og videre transport.</p>
          </div>
        </details>
      </div>
    </section>
    ...
    <section class="tc-panel" id="om-os">
      ...
      <div class="tc-about-list">
        <article class="tc-about-item">
          ...
          <div>
            <h4>Vi vurderer flypassagerers rettigheder</h4>
            ...
            <span class="tc-about-tag">EU 261/2004</span>
          </div>
        </article>
        <article class="tc-about-item">
          ...
          <div>
            ...
            <p>Landing-siden flytter rejsestatus op foran flowet. Derfor går du direkte videre til billet, flyafgang og hændelse, som afgør retningen i sagen.</p>
          </div>
        </article>
        <article class="tc-about-item">
          <span class="tc-about-icon" aria-hidden="true">🤝</span>
  ...
  <section class="tc-panel tc-contact-panel" id="kontakt">
    ...
    <div class="tc-contact-footer">
      ...
      <span class="tc-contact-email-note">Vi svarer så hurtigt som muligt og hjælper dig videre til det rigtige flyspor.</span>
    </div>
  </section>
    ...
    <div class="tc-site-footer-inner">
      <div class="tc-site-footer-stats">
        <div class="tc-site-footer-stat">
          <div class="tc-site-footer-stat-value">42.500+</div>
          <div class="tc-site-footer-stat-label">flykrav vurderet</div>
        </div>
        <div class="tc-site-footer-stat">
          <div class="tc-site-footer-stat-value">EU261</div>
          <div class="tc-site-footer-stat-label">kompensation, assistance og remedies</div>
        </div>
        <div class="tc-site-footer-stat">
      ...
      <div class="tc-site-footer-bottom">
        <div><strong>AirClaim</strong></div>
        <div>Baseret paa EU-forordning 261/2004</div>
        <div>&copy; 2026</div>
      </div>
    </div>
  </footer>
...
<script>
  (function () {
    ...
    function formatDkk(value) {
      ...
      return new Intl.NumberFormat(locale, { maximumFractionDigits: 0 }).format(value) + ' EUR';
    }

    function updateCompTeaser() {
      const delay = Number(delayInput.value || 0);
      const distance = Number(priceInput.value || 0);

      let amount = 0;
      let tierKey = '0';
      let color = '#94a3b8';
      let progressWidth = `${Math.max(2, (delay / 180) * 50)}%`;
      ...
      priceValue.textContent = new Intl.NumberFormat(locale, { maximumFractionDigits: 0 }).format(distance) + ' km';
      amountValue.textContent = amount > 0 ? `${amount} EUR` : '0 EUR';
      amountSub.textContent = amount > 0
        ? (uiLang === 'fr'
            ? `${amount} EUR pour ${delay} minutes de retard`
            : `${amount} EUR ved ${delay} minutters forsinkelse`)
        : (uiLang === 'fr'
            ? 'Aucune compensation en dessous de 180 minutes de retard'
            : 'Ingen kompensation under 180 minutters forsinkelse');

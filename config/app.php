...
return [
    ...
    /*
     * External integrations and feature toggles
     */
    'External' => [
        // Master switch to use live external APIs (DB/SNCF/RNE etc.). When false, app sticks to provided/mock data.
        'useLiveApis' => filter_var(env('USE_LIVE_APIS', false), FILTER_VALIDATE_BOOLEAN),
        // Public transport REST for DB (community API). Adjust if needed.
        'dbTransportRestBase' => env('DB_TRANSPORT_REST_BASE', 'https://v6.db.transport.rest'),

...
/*
 * Polyfill deprecated magic quotes functions for older libraries (e.g., FPDF).
 * On PHP 8+, get_magic_quotes_runtime/set_magic_quotes_runtime were removed.
 */
if (!function_exists('get_magic_quotes_runtime')) {
    function get_magic_quotes_runtime(): bool { return false; }
}
if (!function_exists('set_magic_quotes_runtime')) {
    function set_magic_quotes_runtime($new_setting): bool { return false; }
}
